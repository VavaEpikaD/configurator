export { MaterialLibrary } from './materials/MaterialLibrary.js?v=1';
export { MATERIAL_PRESETS } from './materials/presets.js?v=1';
...
export { createSurfaceSystem, SURFACE_SYSTEM_VERSION } from './createSurfaceSystem.js?v=2';
export { GeometryLibrary, GEOMETRY_SYSTEM_VERSION } from './geometry/GeometryLibrary.js?v=2';
