export { MaterialLibrary } from './materials/MaterialLibrary.js?v=7';
export { MATERIAL_PRESETS } from './materials/presets.js?v=7';
...
export { createSurfaceSystem, SURFACE_SYSTEM_VERSION } from './createSurfaceSystem.js?v=8';
