...
import { createSceneContext } from './scene.js?v=pbr-7';
import { initializeUIControls } from './ui-controls.js?v=4';
import { createWindowBuilder } from './window-builder.js?v=pbr-7';
import { createMaterialManager } from './materials.js?v=pbr-7';
import { createARController } from './ar-controller.js';
import { createCadReferenceController } from './cad-reference.js';
import { createProfileController } from './profile-controller.js?v=pbr-7';
